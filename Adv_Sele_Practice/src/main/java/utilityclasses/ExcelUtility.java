...
public class ExcelUtility {
	...
	public String readDataFromExcelFile(String sheetName, int rowNum, int cellNum) throws EncryptedDocumentException, IOException {
		FileInputStream fis1 = new FileInputStream("src/test/resources/NinzaCRM.xlsx");
	...
	public String readNumericDataFromExcelFile(String sheetName, int rowNum, int cellNum) throws EncryptedDocumentException, IOException {
		FileInputStream fis1 = new FileInputStream("src/test/resources/NinzaCRM.xlsx");
		Workbook wb = WorkbookFactory.create(fis1);
